...
- 2026-01-19: Host Header Injection; avoid deriving redirect destinations from the incoming request (e.g. req.url, Host header) and instead use trusted static configuration values.
