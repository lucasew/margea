...
- 2026-07-02: Extracted duplicate secure request checking logic into `isSecureRequest` in `src/utils/requestUtils.ts` to reduce debt and comply with project conventions.
